...
<div class="overview-wrap" style="">
    <div class="overview-left">
        ...
        <div class="contact-id" style="width: 100%;display:flex; ">
            <div class="contact-id-text setting" style="flex-basis:40%">Usuario</div>
            <div class="contact-id-number setting" style="flex-basis:60%"><?php echo $userdata->userLink;?></div>
        </div>
        <br><br>
         <div class="contact-id" style="width: 100%;display:flex; ">
            <div class="contact-id-text setting" style="flex-basis:40%">Email</div>
            <div class="contact-id-number setting" style="flex-basis:60%"><?php echo $userdata->email;?></div>
        </div>
        <br><br>
        <div class="about-border"></div><div class="about-work-heading">WEBSITE AND SOCIAL LINKS</div>
        <div class="about-border"></div>
