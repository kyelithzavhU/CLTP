...
CREATE TABLE `profile` (
  ...
  `pet_raza` varchar(255) DEFAULT NULL,
  `pet_especie` varchar(255) DEFAULT NULL,
...
CREATE TABLE `token_res` (
  `id` int(11) NOT NULL,
  `token_for` varchar(255) NOT NULL,
  `user_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
ALTER TABLE `block`
  MODIFY `blockID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
...
ALTER TABLE `react`
  MODIFY `reactID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1;
