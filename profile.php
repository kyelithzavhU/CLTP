                    ...
                    <div class="bio-wrap">
                        <div class="bio-intro">
                            ...
                            <div class="intro-icon-text">
                                ...
                                <div class="add-bio-click"><a href="about.php">Add Bio</a></div>
                            </div>
        ...
        $(function() {
            ...
            $(document).on('keyup', '.emojionearea-editor', function() {
                ...
                if (regex_text != null) {
                    ...
                    $.post('http://localhost/cltp/core/ajax/hashtag_mention.php', {
            ...
            $(document).on('click', '.block-show', function() {
                ...
                $.post('http://localhost/cltp/core/ajax/block.php', {
                    profileid: profileid,
                    userid: userid
                }, function(data) {
                    location.reload();
